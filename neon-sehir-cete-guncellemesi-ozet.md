...
Oyuncunun üç temel istatistiği var: Altın (para birimi), Şüphe (%0-100, suç işledikçe artar, yakalanma riskini belirler) ve Saygınlık (%0-100, yakın zamanda yalnızca suçtan yakalanınca düşer; seyyar satıcıdan alışveriş veya ibadet gibi eylemlerle yükselir — kazanım kademelidir: saygınlık 0–49 iken +5, 50–79 iken +3, 80 ve üzerinde +1; bu eylemler aynı zamanda şüpheyi 5 düşürür; ekip soygunlarında araya polis sızdığında esnafların oyuncuyu uyarma ihtimalini etkiler).
